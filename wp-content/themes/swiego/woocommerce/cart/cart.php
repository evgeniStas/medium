		...
		<tbody>
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						if ( ! $product_permalink ) {
							...
							printf( '<a data-product_id="'.$product_id.'" class="yith-wcqv-button" href="%s">%s</a>', esc_url( $product_permalink ), $thumbnail );
						}
						?></td>
						...
						<td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>"><?php
							...
							echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<a data-product_id="'.$product_id.'" class="yith-wcqv-button" href="%s">%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key );
						}
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<button style="padding: 18px!important;" type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'UPDATE CART', 'woocommerce' ); ?>"><?php esc_html_e( 'UPDATE CART', 'woocommerce' ); ?></button>
