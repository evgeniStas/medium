...
if ( ! function_exists( 'woocommerce_template_loop_product_link_open' ) ) {
	...
	function woocommerce_template_loop_product_link_open() {
		...
		echo '<a data-product_id="'.$product->get_id().'" href="' . esc_url( $link ) . '" class="woocommerce-LoopProduct-link woocommerce-loop-product__link yith-wcqv-button">';
	}
}
...
function wc_get_formatted_cart_item_data( $cart_item, $flat = false ) {
	...
	if ( $cart_item['data']->is_type( 'variation' ) && is_array( $cart_item['variation'] ) ) {
		foreach ( $cart_item['variation'] as $name => $value ) {
		    ...
		    //var_dump($cart_item);
            //$meta_values = get_post_meta($cart_item["variation_id"]);
            //var_dump($cart_item["variation"]["attribute_pa_color"]);
