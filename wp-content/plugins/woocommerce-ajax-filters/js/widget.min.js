...
(function ($){
    $(document).ready(function (){
        ...
        $('.berocket_aapf_all').on("click", function(){
            if(!$('.berocket_aapf_all').hasClass('berocket_checked')) {
                $(this).addClass("berocket_checked");
                berocket_aapf_widget_product_filters = [];
                berocket_aapf_widget_selected_filters = [];
                var input = $('#berocket_aapf_widget-3 input');

                $.each(input, function (key, value) {
                    if ($(this).data("term_id")) {
                        $(this).prop('checked', true);
                        $(this).parent().children("label").addClass("berocket_checked");
                    }
                });
            }else{
                $(this).removeClass("berocket_checked");
                berocket_aapf_widget_product_filters = [];
                berocket_aapf_widget_selected_filters = [];
                var input = $('#berocket_aapf_widget-3 input');
                ...
                $.each(input, function (key, value) {
                    if ($(this).data("term_id")) {
                        ...
                        $(this).parent().children("label").removeClass("berocket_checked");
                    }
                });
            }
            updateProducts();
        ...
        $('.berocket_aapf_widget').on("change", "input, select", function(){
            if($('.berocket_aapf_all').hasClass('berocket_checked')){
                //alert(1);
                $('.berocket_aapf_all').removeClass("berocket_checked");
                berocket_aapf_widget_product_filters = [];
                berocket_aapf_widget_selected_filters = [];
                var input = $('#berocket_aapf_widget-3 input');
